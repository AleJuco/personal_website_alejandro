...
export const projects: Project[] = [
  ...
  },
  {
    id: "3",
    title: "Baymini",
    description: "Currently developing an AI-powered tool that leverages machine learning for intelligent automation and data analysis.",
    image: "/projects/baymin.jpg",
    status: "completed",
    slug: "project-three",
    technologies: ["Python", "TensorFlow", "Machine Learning", "API Development"],
    sourceCode: "https://github.com/yourusername/baymini",
    details: "Baymini is an AI-powered assistant designed to help with various automation tasks. It uses machine learning models to understand context and provide intelligent responses. The project explores natural language processing, model training, and building user-friendly AI interfaces.",
    timeline: "2025",
    photos: ["/projects/baymin1.png"],
