...
export async function generateMetadata({ params }: ProjectPageProps) {
  ...
  return {
    title: `${project.title} | Alejandro Imperial`,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[50vh] w-full">
        ...
        <Link
          href="/"
          className="absolute top-8 left-8 flex items-center gap-2 text-white bg-black/30 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-black/50 transition-colors duration-300"
        >
          <svg
            className="w-5 h-5"
            fill="none"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-wrap gap-2 mb-4">
              <span
                className={`inline-block px-3 py-1 text-sm font-medium rounded-full border ${statusStyles[project.status]}`}
              >
              ...
              {project.tags?.map((tag, index) => (
                <span
                  key={index}
                  className="inline-block px-3 py-1 text-sm font-medium rounded-full border bg-blue-100 text-blue-800 border-blue-200"
                >
                  {tag}
                </span>
              ))}
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          {(project.technologies?.length > 0 || project.timeline) && (
          ...
          {project.video && (
            <div className="mt-12">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Project Demo</h3>
